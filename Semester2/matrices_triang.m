function [M,N] = matrices_triang(r,epsilon,k,kprime,delta,deltaprime,d,dprime,q,qbar,R0,B0,n,size,band,npoints,i)
...
if savecoeff
    ...
    load('geom.mat')
    Mgeom(i,:) = Mtheta(r,theta,k,kprime,delta,deltaprime,d,dprime,epsilon,qbar);
    Ngeom(i,:) = Ntheta(r,theta,k,kprime,delta,deltaprime,d,dprime,epsilon,qbar);
...
if savefourier
    load('coeffgeom.mat')
    coeffsMgeom(i,:) = coeffs_M;
    coeffsNgeom(i,:) = coeffs_N;
