...
for i=1:nr
    epsilon=r(i)/R0;
    delta = deltafct(r(i),i);
        k = kfct(r(i));
        d = dfct(r(i));
%         disp(k)
        qbar = qbar_triang(q(r(i)),r(i),k,kprime,delta,deltaprime,d,dprime,R0,npoints,Option);
    
    [M,N] = matrices_triang(r(i),epsilon,k,kprime(i),delta,deltaprime(i),d,dprime(i),q(i),qbar,R0,B0,n,size,band,npoints);
