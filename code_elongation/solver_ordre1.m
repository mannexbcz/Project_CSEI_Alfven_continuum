...
% case of an elongated and shifted equilibrium, and in the first order
% approximation.
% -------------------------------------------------------------------------
%%
...
%% Eigenmodes
r=linspace(0,a,nr);
w = eigenmodes_ordre1(size,band,kfct,k_a,kprime,deltafct,deltaprime,q,R0,B0,a,n,nr,npoints);
