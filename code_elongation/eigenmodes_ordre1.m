function w = eigenmodes_ordre1(size,band,kfct,k_a,kprime,deltafct,deltaprime,q,R0,B0,a,n,nr,npoints)
% Computes the Alfvén eigenmodes by solving the matrix form of the Alfvén
% continuum equation, for the elongated and shifted case, and in the first
% order approximation. 
% Inputs:
